                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm mb-6">
                                ...
                                <span className="text-white/90 text-sm font-bold uppercase tracking-wider">İletişime Geçin</span>
                            </div>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#145BEC] to-[#0d47c9] p-12 md:p-16 text-center max-w-4xl mx-auto">
                            ...
                            <div className="relative z-10">
                                ...
                                <h2 className="font-black text-white mb-4">Doğrudan İletişimi mi Tercih Ediyorsunuz?</h2>
                                <p className="text-xl text-white/80 mb-8 max-w-[500px] mx-auto">
                                    Hızlı yanıtlar ve gerçek zamanlı destek için WhatsApp üzerinden bize ulaşın.
                                </p>
