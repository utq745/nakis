...
export default async function PaymentPage({
    ...
    if (!session?.user) redirect("/tr/login");
    ...
    if (order.status !== "PAYMENT_PENDING") redirect(`/tr/orders/${id}`);
    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-5xl">
            ...
            >
                ...
                <span>Siparişe Dön</span>
            </Link>

            <div className="mb-12">
                <h1 className="text-3xl font-bold text-white mb-2">Ödeme Yap</h1>
                <p className="text-zinc-400">Final dosyalarını indirmek için ödeme işlemini tamamlayın.</p>
            </div>
