                        ...
                        <CardContent>
                            <Tabs defaultValue="original" className="w-full">
                                ...
                                <TabsContent value="original" className="mt-4">
                                    <FileList
                                        files={originalFiles}
                                        emptyText={t.orders.noFiles || "Henüz dosya yüklenmemiş"}
                                        isAdmin={isAdmin}
                    ...
                    <div key={file.id}>
                        ...
                        <div className="flex items-center justify-between p-3 rounded-lg bg-accent/50">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                {isLocked && (
                                    <div className="p-2 rounded-lg bg-accent/50 text-muted-foreground" title={language === 'tr' ? 'Final dosyaları henüz hazır değil' : 'Final files are not ready yet'}>
