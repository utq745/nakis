    ...
    const nextStep = () => {
        ...
        if (step === 4) {
            ...
            if (productType === "Cap" && (!capType || !capPlacement)) {
                toast.error("Lütfen şapka tipi ve yerleşimi seçin");
                return;
            }
                            ...
                            <div className="p-5 rounded-xl border border-violet-500/40 bg-violet-500/5 space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div className="space-y-2">
                                        <Label htmlFor="designWidth">En ({designUnit})</Label>
                                        <Input
                                            id="designWidth"
                                            type="number"
                                            min="0"
                                            ...
                                            placeholder={`${designUnit} cinsinden en`}
                                            className="bg-background border-border text-foreground"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        <Label htmlFor="designHeight">Boy ({designUnit})</Label>
                                        <Input
                                            id="designHeight"
                                            type="number"
                                            min="0"
                                            ...
                                            placeholder={`${designUnit} cinsinden boy`}
                                            className="bg-background border-border text-foreground"
                                        />
                                    </div>
                                </div>
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        {productType === "Cap" && (
                            <div className="p-6 bg-card border border-border rounded-2xl space-y-5">
                                <div className="space-y-3">
                                    <Label className="text-muted-foreground text-sm font-semibold uppercase tracking-wider block">Şapka Tipi</Label>
                                ...
                                <div className="space-y-3">
                                    <Label className="text-muted-foreground text-sm font-semibold uppercase tracking-wider block">Yerleşim</Label>
                                    <div className="flex flex-wrap gap-3">
