                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    {/* Subject */}
                                    <div>
                                        <label htmlFor="subject-input" className="block text-sm font-medium text-foreground mb-2">
                                            {cp.subjectLabel}
                                        </label>
                                        <select
                                            id="subject-input"
                                        ...
                                        {formErrors.subject && (
                                            <p id="subject-error" role="alert" className="mt-1 text-xs text-red-500 font-medium">{formErrors.subject}</p>
                                        )}
                                    </div>
