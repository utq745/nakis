...
import { MessageSquare, Mail, ArrowRight, Clock, CheckCircle2, Send } from "lucide-react";
                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 dark:bg-white/10 border border-primary/10 dark:border-white/20 backdrop-blur-sm mb-6">
                                <MessageSquare className="text-primary dark:text-white size-5" />
                                    ...
                                    <div className="space-y-4">
                                        {contactMethods.map((method, index) => (
                                            <div key={index}>
                                                <a
                                                    href={method.href}
                                                    target={(method.isWhatsApp || method.isSocial) ? "_blank" : undefined}
                                                    rel={(method.isWhatsApp || method.isSocial) ? "noopener noreferrer" : undefined}
                                                ...
                                                >
                                                    ...
                                                    <ArrowRight className="ml-auto text-muted-foreground group-hover:text-primary transition-colors size-5" />
                                                </a>
                                                {method.isWhatsApp && (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            ...
                                            />
                                            {formErrors.name && (
                                                <p id="name-error" role="alert" className="mt-1 text-xs text-red-500 font-medium">{formErrors.name}</p>
                                            )}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {formErrors.email && (
                                                <p id="email-error" role="alert" className="mt-1 text-xs text-red-500 font-medium">{formErrors.email}</p>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {formErrors.message && (
                                            <p id="message-error" role="alert" className="mt-1 text-xs text-red-500 font-medium">{formErrors.message}</p>
                                        )}
                                    </div>
