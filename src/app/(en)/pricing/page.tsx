                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center gap-3 flex-1">
                                            ...
                                            <h4 className="font-bold text-[#111318] dark:text-white">{faq.q}</h4>
                                        </div>
                                    ...
                                    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openFaqIndex === index ? 'max-h-96' : 'max-h-0'}`}>
