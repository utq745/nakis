                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border border-border bg-muted/50 dark:bg-muted/10 text-foreground focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border border-border bg-muted/50 dark:bg-muted/10 text-foreground placeholder-muted-foreground focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none"
                                        />
                                    </div>
