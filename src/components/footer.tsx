                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:flex gap-12">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Link className="text-muted-foreground hover:text-primary transition-colors text-sm" href={language === 'tr' ? '/tr/fix-your-dst' : '/fix-your-dst'}>{t.header.fixYourDst}</Link>
