                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <h1 className="text-[clamp(1.75rem,4vw,3.25rem)] font-black tracking-tight text-primary dark:text-white leading-[1.1] break-words" dangerouslySetInnerHTML={{ __html: t.landing.hero.titleLine1 + (t.landing.hero.titleLine2 ? `<br /><span class="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">${t.landing.hero.titleLine2}</span>` : '') }}>
                            </h1>
