...
export const translations = {
    tr: {
        ...
        orders: {
            ...
            payButton: "Ödeme Yap",
            paymentPendingDesc: "Final dosyaları hazır olduğunda indirebilirsiniz.",
            ...
            previewApproved: "Önizleme onaylandı, sipariş devam ediyor!",
    ...
    en: {
        ...
        orders: {
            ...
            paymentPendingDesc: "You can download final files once they are ready.",
            ...
            previewApproved: "Preview approved, order continues in progress!",
